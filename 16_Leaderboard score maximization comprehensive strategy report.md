...
# Voting≥6 (60% 합의)
python scripts/ensemble_mixed_backbone.py \
  --models ${models[@]} \
  --voting 6 \
  --iou 0.5 \
...
1. 5-Fold 전체 학습 완료
2. Voting≥3 앙상블 제출 → **96.70%** 달성
3. Soft Voting 실험 → **96.75%** 도전

**🎯 Week 2 목표**

1. 혼합 앙상블 (ResNet50 + EfficientNet-B4) → **96.80%** 달성
2. TTA 구현 및 적용 → **96.90 ~ 97.00%** 최종 목표
