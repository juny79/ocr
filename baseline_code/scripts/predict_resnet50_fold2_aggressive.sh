...
echo "========================================"
echo "Starting ResNet50 Fold 2 Prediction (Aggressive)"
echo "Time: $(date)"
echo "========================================"
...
echo "========================================"
echo "ResNet50 Fold 2 prediction completed"
echo "Time: $(date)"
echo "========================================"

# Show generated JSON
JSON_FILE=$(ls -t outputs/resnet50_fold2_aggressive_predict/submissions/*.json 2>/dev/null | head -1)
if [ -n "$JSON_FILE" ]; then
