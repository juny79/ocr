...
echo "========================================"
echo "Starting ResNet50 Fold 3 Prediction (Aggressive)"
echo "Time: $(date)"
echo "========================================"
...
CHECKPOINT=$(ls -t outputs/resnet50_fold3/checkpoints/*.ckpt | head -1)
...
python runners/predict.py \
    ...
    exp_name=resnet50_fold3_aggressive_predict

echo "========================================"
echo "ResNet50 Fold 3 prediction completed"
echo "Time: $(date)"
echo "========================================"

# Show generated JSON
JSON_FILE=$(ls -t outputs/resnet50_fold3_aggressive_predict/submissions/*.json 2>/dev/null | head -1)
if [ -n "$JSON_FILE" ]; then
